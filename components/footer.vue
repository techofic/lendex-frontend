            ...
            <div class="info">
                <div class="container">
                    <div class="info-item">
                        ...
                        <div class="footer-logo">Lendex</div>
                    </div>
                </div>
            </div>
        </div>
